                ...
                <div className="main">
                    ...
                    <div className="bio-outer">
                        <div className="bio-container">
                            <a href="/3dprinting-prototyping" className="main-bio" id="print-card">
                                <h2>3D Printing</h2>
                                <img src={image2} className="bio-pic" alt="3D Printer"/>
                            ...
                            <a href="/webdevelopment" className="main-bio" id="web-card">
                            ...
                            <a href="/3dprinting-prototyping" className="main-bio" id="proto-card">
                                <h2>Prototyping</h2>
